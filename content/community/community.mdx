...
This editor is a proof of concept, is no longer maintained and was based on an older version of JSON Forms.

:::

The JSON Forms editor is a visual editor for the JSON Forms schema and JSON Forms uischema.
