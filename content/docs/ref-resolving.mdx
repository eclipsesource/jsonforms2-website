...
We recommend using a library like `json-refs` ([Documentation](https://github.com/whitlockjc/json-refs/tree/master/docs)) or `json-schema-ref-parser` ([Documentation](https://apitools.dev/json-schema-ref-parser/)) for these use cases.
