---
id: what-is-jsonforms
title: What is JSON Forms?
description: JSON Forms is a declarative framework for efficiently building form-based web UIs.
slug: /
---
...
} from '../../src/components/docs/what-is-jsonforms';
...
Forms are then rendered with a UI library or framework, e.g. [React](integrations/react) or [Angular](integrations/angular).
