...
Finally, we can return the original control, with added HTML elements around it. We use the [Interface](https://www.typescriptlang.org/docs/handbook/interfaces.html) ControlProps, imported from core, to make sure our props
