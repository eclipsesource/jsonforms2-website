...
import { Example, ExampleWithCustomLabel, ExampleWithSortButtons, ExampleWithArrayLabel, ExampleWithRadioGroup } from './components/controls'
...
This options is used to display an enum as a radio group.
