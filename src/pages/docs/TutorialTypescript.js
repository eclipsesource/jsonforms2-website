...
const installation = require('!raw-loader!./listings/installationYarn.md');
const setupStore = require('!raw-loader!./listings/setupStore.md');
const render = require('!raw-loader!./listings/renderTypescript.md');
...
const Tutorial = () => (
  <DocPage>
    ...
    <ol>
      ...
      <li>
        <Typography variant='body1'>
          Switch to the <code>src</code> directory and open <code>index.tsx</code> with an editor of your choice.
      ...
      <li>
        <Typography variant='body1'>
          Still in <code>index.tsx</code>, create a new store with the <code>createStore</code> function provided by redux.
      ...
      <li>
        <Typography variant='body1'>
          Open the <code>App.tsx</code> file and
