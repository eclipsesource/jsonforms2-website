...
<Note
  title='ATTENTION'
  body={<span>As of JSON Forms 2.5 the React-Redux variant is deprecated in favor of the JSON Forms "standalone" component.
        ...
        For the legacy Redux integration, see <a href="/docs/redux">here</a>.</span>}
/>
