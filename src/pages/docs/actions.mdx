...
<Note
  title='ATTENTION'
  body='Deprecated: Please note that we are working towards removing the Redux integration. To ease migration, we recommend using the standalone component. Functionality previously available via actions can be replaced with corresponding props on the standalone component.'
/>
...
<ApiLink
  link='/public/api/core/interfaces/addrendereraction.html'
  title='API'
/>
...
<ApiLink
  link='/public/api/core/interfaces/adduischemaaction.html'
  title='API'
/>
